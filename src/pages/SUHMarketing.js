      ...
      <div>
        ...
        <section className="container">
          <div className="screenshot__wrap screenshot__wrap--teal screenshot__wrap--scrollable">
            <div>
              <img alt="" src="/img/suhmarketing-top-screenshot.webp" srcSet="/img/suhmarketing-top-screenshot@2x.webp 2x" />
            </div>
          </div>
        ...
        <section className="container container__full">
          <Slider {...slickSettings}>
            <div className="screenshot__wrap screenshot__wrap--yellow">
              <img alt="" src="/img/suhmarketing-slider-1.webp" srcSet="/img/suhmarketing-slider-1@2x.webp 2x" />
            </div>

            <div className="screenshot__wrap screenshot__wrap--blue">
              <img alt="" src="/img/suhmarketing-slider-2.webp" srcSet="/img/suhmarketing-slider-2@2x.webp 2x" />
            </div>

            <div className="screenshot__wrap screenshot__wrap--green">
              <img alt="" src="/img/suhmarketing-slider-3.webp" srcSet="/img/suhmarketing-slider-3@2x.webp 2x" onLoad={this.handleImageLoaded.bind(this)} />
            </div>
          </Slider>
        ...
        <section className="container">
          <div className="grid-fifty">
            <div className="screenshot__wrap screenshot__wrap--scrollable">
              <div>
                <img alt="" src="/img/suhmarketing-mobile-screenshot.webp" srcSet="/img/suhmarketing-mobile-screenshot@2x.webp 2x" />
              </div>
            </div>
          </div>
